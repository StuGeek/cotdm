...
def deploy_single_model_deepplan(model_info, stage_list_cpu):
    stage_list = []
    ...
    if global_config.DEPLOY_ALG == "Min Deploy":
        ...
        _, load_index = cal_lat_by_deploynum_and_avaigpu(half_mem_idx, total_layer_num, init_deploy_cotdm.default_use_gpu_num, single_layer_time)
